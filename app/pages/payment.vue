  ...
  <div class="p-4 md:p-8 max-w-lg mx-auto">
    ...
    <div class="space-y-4">
      ...
      <UButton
        ...
        :disabled="!isBrickReady || isProcessing"
      >
...
const paymentAmount = ref(10.50); // Valor inicial de exemplo
...
async function processPayment() {
  ...
  try {
    // Pega os dados do formulário do brick
    const cardFormData = await brickController.getFormData();
    // Envia para a função de submissão
    await submitPayment(cardFormData);
  } catch (error) {
    // O brick rejeita a promessa em caso de erro de validação
